...
- =dron apply= imports the drontab module, generates backend units, diffs them
  against managed units, and applies the plan
- =dron lint= imports the drontab module and verifies the generated units without
  applying changes
